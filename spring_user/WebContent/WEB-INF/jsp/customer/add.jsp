...
<table width="700" align="center" border="1">
	<tr>
	<td>客户名称:</td><td><sf:input path="customerName"/><sf:errors path="customerName"/></td>
	</tr>
	<tr>
	...
	<tr>
	<td>其他信息:</td><td><sf:input path="otherInfo"/><sf:errors path="otherInfo"/></td>
	</tr>
	<tr>
	
	<td colspan="2">
		<input type="submit" value="客户添加"/>
	</td>
	</tr>
</table>
</sf:form>
